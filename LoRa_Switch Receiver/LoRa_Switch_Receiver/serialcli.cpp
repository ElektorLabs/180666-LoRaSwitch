...
void SerialConsolePrintWelcome( void ){
  if(Serial){
    Serial.println(F(" LoRa Switch Receiver"));
...
void SerialCommandShowHelp( void ){
    ...
    Serial.println(F("set key <key>       -> This will set the key used ( 8 to 32 chars )"));
    Serial.println(F("get key             -> This will get the key used"));
    Serial.println(F("set txpower <pwr>   -> This will set the tx power used ( 2 to 15 )"));
    Serial.println(F("set state <state>   -> This will set the the remote relais ( ON / OFF )"));
    Serial.println(F("get datarate        -> This will show the actual datarate"));
    Serial.println(F("set datarate <SF>   -> This will set the actual datarate (SF7 to SF10)"));
                                ...
                                switch ( command.command ){
                                    ...
                                    case cmd_state:{
                                        ...
                                        if(keyword == KW_ON){
                                            ...
                                            Serial.println("Set Relay to ON ");
                                        } else if( keyword == KW_OFF){
                                            SetSwitchActiveState( false );
                                            Serial.println("Set Relay to OFF ");
